...
final TextEditingController _desc = TextEditingController();
  ...
  TimeOfDay time = TimeOfDay.fromDateTime(DateTime.parse(_time.text));
  ...
  // Convert the scheduled date to a TZDateTime
  tz.TZDateTime scheduledAt = tz.TZDateTime.from(scheduledDate, tz.local);
